        ...
        <div class="container navigation-bar">
          ...
          @endguest
                ...
                <ul class = "non-responsive">
                    ...
                    <!-- <li class = "{{ (request()->is('notification*')) ? 'active' : ''}}"><a href="/login"><img style=" position:absolute;right:12%;top:18%;height:30px;width:30px  " src="{{asset('images/bell.svg')}}" alt=""></a></li> -->
                    @else
                    <!--  
                    @if($c=='0')
                    <div style="width:12px;position:absolute;right:11%;top:12%;background:red; color:white;text-align:center"> <strong> {{$c}}</strong></div>
                    @endif
                    <li class = "{{ (request()->is('notification*')) ? 'active' : ''}}"><a href="/notification"><img style=" position:absolute;right:12%;top:18%;height:30px;width:30px  " src="{{asset('images/bell.svg')}}" alt=""></a></li> -->
                    @endguest
                  </ul>
